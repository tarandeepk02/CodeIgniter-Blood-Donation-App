      ...
      <div class="row">
        <div class="col-md-12">
          <div class="ibox">
            ...
            <?php } ?>
            <div class="ibox-body"> <?php echo form_open('admin/Profile/updateprofile',['name'=>'signup']);?>
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label>First Name</label>
                    <?php echo form_input(['name'=>'name','id'=>'name','class'=>'form-control','placeholder'=>'Enter your Name','value'=>set_value('fromdate',$profile->name)]);?> <span style="color:red;"><?php echo form_error('name')?></span> </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
                    <label>Email</label>
                    <label>Email</label>
                    <?php echo form_input(['name'=>'email','id'=>'email','class'=>'form-control','placeholder'=>'Email','value'=>set_value('fromdate',$profile->email)]);?> <span style="color:red;"><?php echo form_error('email')?></span> </div>
                </div>
              </div>
