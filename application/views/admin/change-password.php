      ...
      <div class="row">
        <div class="col-md-6">
          <div class="ibox">
            ...
            <?php } ?>
            <div class="ibox-body"> <?php echo form_open('admin/Changepwd',['name'=>'signup']);?>
              <div class="row">
              ...
              <div class="form-group"> <?php echo form_submit(['name'=>'submit','id'=>'submit','class'=>'btn btn-primary','value'=>'Change Password']);?> </div>
