      ...
      <div class="row">
        <div class="col-md-12">
          <div class="ibox">
            ...
            <?php } ?>
            <div class="ibox-body"> <?php echo form_open('admin/Bloodgroup/add',['name'=>'signup']);?>
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label>Add Blood Group Name</label>
                    <?php echo form_input(['name'=>'name','id'=>'name','class'=>'form-control','placeholder'=>'Enter Blood Group Name']);?> <span style="color:red;"><?php echo form_error('name')?></span> </div>
                </div>
              </div>
              <div class="form-group"> <?php echo form_submit(['name'=>'submit','id'=>'submit','class'=>'btn btn-primary','value'=>'Submit']);?> </div>
