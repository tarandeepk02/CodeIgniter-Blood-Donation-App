...
<div class="content">
  ...
  <div class="text-center">Not a member? <a class="color-blue" href="<?php echo base_url('user/registration');?>">Create accaunt</a> </div>
  <hr />
  <p style="text-align:center;"> <a class="nav-link scrollto" href="<?php echo base_url('Welcome'); ?>">Back to Home Page</a></p>
